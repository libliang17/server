...
int spider_db_fetch_row(
  ...
  int error_num;
  Time_zone *saved_time_zone = field->table->in_use->variables.time_zone;
  ...
  field->table->in_use->variables.time_zone = saved_time_zone;
    ...
    else
    {
      if (field && field->type() == FIELD_TYPE_TIMESTAMP)
      {
        ...
        */
        ...
        saved_time_zone = table->in_use->variables.time_zone;
